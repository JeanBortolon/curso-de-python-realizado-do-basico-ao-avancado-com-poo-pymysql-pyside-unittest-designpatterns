...
'''Utilizando f-strings posso formatar de
maneiras mais simples a exibicação
das strings inserindo as variaveis entre chaves
também posso formatar casa decimais
colocar dois pontos na frente da variavel
na chave e o numero de casa decima :.2f
só preciso abrir e fechar a string 1x com
aspas.'''
linha_1 = f'O Paciente: {nome} mede:{altura} metros e pesa: {peso} quilos possuindo um IMC de:{imc:.2f}'
print(linha_1)