...
Parte 1 - Criar o teste e ver falhar (Red)
Parte 2 - Criar o código e ver o teste passar (Green)
Parte 3 - Melhorar meu código (Refactor)
'''
try:
    import sys
    import os
...
from conceito_tdd import bacon_com_ovos
import unittest

class TestBaconComOvos(unittest.TestCase):
    def test_bacon_com_ovos_levanta_assertion_error_se_nao_receber_int(self):
